...
INSERT INTO `sqlserversas`.`announcement` ( `announcementTitle`, `announcementDescription`, `announcementCategory`, `announcementDisplay`) VALUES ( 'บริษัท เน็ตเซอร์พลัส จำกัด รับสมัครงาน 2 ตำแหน่ง', 'บริษัท เน็ตเซอร์/พลัส จํากัด เปิดรับสมัครงาน 2 ตําแหน่ง Application Support และ Customer Support', '3', 'N');
